<?php
    ...
    $orders = query("SELECT * FROM orders where status ='dibatalkan'");
?>
<!DOCTYPE html>
<html lang="en">
<head>
    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            <a href="http://localhost/studi-kasus-1-bungafairuz/makanan.php" class="nav-link">
          ...
          <li class="nav-item">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="offset-md-2 nav-item">
                <a href="http://localhost/studi-kasus-1-bungafairuz/pesanan_diproses.php" class="nav-link">
